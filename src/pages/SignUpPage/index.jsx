            ...
            >
              {imageUrl ? (
                ...
                uploadButton
                  ...
                  <StyledFormItem>
                    <SignUpButton loading={buttonloading} onClick={() => { navigate("/editprofileownerpage"); signUpNavigate(firstname,lastname,username,password, email,phoneNumber) }}>Registruj se</SignUpButton>
                  </StyledFormItem>
                </StyledForm>
            </Cover>
        </Page>
