...
const PetListPage = () => {
  ...
  useEffect( () => {
    ...
    .catch((e) => console.log(e));
  }, [pets, types, isCalled, user.token, typeFilterName, locations, users, places]);
        ...
        <Content style={{ maxHeight: '103vh' }}>
          <Page>
            <Cover>
              ...
              <Modal title="Filtriranje" open={isModalOpen2} onOk={filterByType} onCancel={handleCancel2} 
                okText="Filtriraj" cancelText="Otkaži" >
